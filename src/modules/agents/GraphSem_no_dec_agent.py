...
class GraphSem_no_dec_agent(nn.Module):
    def __init__(self, input_shape, args):
        super(GraphSem_no_dec_agent, self).__init__()
        self.args = args
    ...
    def forward(self, inputs, hidden_state):
        ...
        # w/o Dec: directly feed historical information into local utility network
        # Use enc_out directly without decoder
        dec_out = enc_out.reshape(-1, self.args.hidden_dim)
