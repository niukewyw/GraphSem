...
class GraphSem_uniform_agent(nn.Module):
    def __init__(self, input_shape, args):
        super(GraphSem_uniform_agent, self).__init__()
        self.args = args
    ...
    def forward(self, inputs, hidden_state):
        ...
        # communicate with uniform weights
        h = h_out.clone()
        ...
        # Use uniform weights instead of hard attention
