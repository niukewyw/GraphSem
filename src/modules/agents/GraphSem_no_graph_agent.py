...
class GraphSem_no_graph_agent(nn.Module):
    def __init__(self, input_shape, args):
        super(GraphSem_no_graph_agent, self).__init__()
        self.args = args
    ...
    def forward(self, inputs, hidden_state):
        ...
        # w/o Graph: directly feed environmental states into mixing network
        # No graph attention communication fusion
        q = self.fc3(h_out)
